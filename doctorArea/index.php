...
<html>
  <head>    
    <meta charset="UTF-8">
    <title>Health Is Wealth - Doctor</title>
				...
				<div class="row">
					...
					<div class="sun clearfix">
						...
						<div id="left-block" class="col-sm-12 text-center">
						     <a href="#" id="registerbutton" data-toggle="modal" data-target="#myModal" class="btn  btn-success">Doctor Register Area</a>
						</div>
							  ...
							  <div class="col-sm-offset-2 col-sm-8">
								...
								<form class="newsletter-signup" role="form">
								  <div class="input-group">
									<input style="color:#000" type="text" placeholder="@9403148108/@doctor_ID/@PravinkumarRaut" class="form-control" id="searchdoctorText" placeholder="contact@yourdomain.com" required>
