...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 22, 2021 at 06:21 AM
...
INSERT INTO `hospitalarea` (`hospitalID`, `hospitalName`, `hospitalPhone`, `hospitalAddress`, `hospitalPinCode`, `fees`, `status`) VALUES
(1, 'Navodaya Hospital', '9403148108', 'Deori', 441901, 100, 1),
(2, 'Nikode Hospital', '9403148100', 'Deori', 441901, 150, 1),
(3, 'Yerne Hospital', '9403148111', 'Deori', 441901, 200, 1),
(4, 'PHC Chichgarh', '0712233445', 'Chichgarh', 441901, 10, 1);
...
(13, '441912343210', 'Jeet', 'Raut', '2014-11-11', 'male', '9403148102 ', 'yes', '', '', 'Dewalgaon', '', '', '', 0, 'yes'),
(14, '663636636362', 'Khushal', 'Jamkate', '1992-01-06', 'male', '8436897882 ', 'yes', '', '', 'Keshori', '', '', '', 441903, 'yes');
...
(4, '23246758', 'Kim', 'Jobs', '1979-11-09', 'female', '9067182123', 'yes', '23', '', 'Test', '', '', '', 441123, ''),
(5, '234534532323', 'Rekha', 'J', '1992-11-16', 'female', '9765434533', 'yes', '34', '', 'Testing', '', '', 'Gondia', 441111, 'yes');
...
--
ALTER TABLE `patienthospital`
  MODIFY `patientHospitalID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=269;
